<template>
  <q-page>
    <q-dialog v-model.trim="store.$state.modalIsOpen">
      <q-card>
        <!-- <q-card-section>
          <div class="text-h6">
            Subscriber
        ...
        <q-card-section class="flex-subscriber">
          ...
          <div class="">
            ...
            <q-field filled label="Mode" stack-label class="q-ma-md">
              <template #control>
        ...
        <q-card-actions align="left">
          ...
          />
          <q-btn flat label="Close" color="primary" @click="onClose" />
        </q-card-actions>
...
const updateDetails = async (id: string) => {
  ...
  await axios
    .put(`${hostIp}/api/subscriber_test/${id}/edit`, {
      acc_no: accNo.value,
